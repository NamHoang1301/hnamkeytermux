...
for X in banner:
  ...
  sleep(0)
print("\033[1;34m⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦")
print(f"""{do}[{vang}</>{do}]THÔNG BÁO:{trang}Tool Đã Được Update Lược Bỏ Bớt Chế Độ
{trang}Thêm Chế Độ Spam Sms + Call
{trang}Update Tự Động Kiểm Tra Thiết Bị Để Chạy Phiên Bản Phù Hợp Với Thiết Bị
{trang}Thêm Tool Tải Video Tiktok
{trang}Fix Lại Tool Buff Tiktok
{trang}Key Tool Tự Động Thay Đổi Khi Hết Hạn 3 Ngày Trong Tương Lai Sẽ Có Key Vip Sử Dụng 1 Tuần """)
print("\033[1;34m⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦")
print("\033[1;35m╔═══════════════════════════════════════╗")
...
if chon == 1 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/tds.py').text)
if chon == 2 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/ttc.py').text)
if chon == 3 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/tienichfb.py').text)
if chon == 4 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/tiktok.py').text)
if chon == 5 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/golike.py').text)
if chon == 6 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/encode.py').text)
if chon == 7 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/spamsms.py').text)
if chon == 8 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/ddos.py').text)
if chon == 9 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/mail.py').text)
if chon == 10:
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/proxy.py').text)
if chon == 11:
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxgop/main/tienich.py').text)
if chon == 00 :
